    ...
    if (request.session.twitterData && request.session.twitterData.signedIn) {
        ...
        twitter.getRequestToken(function(error, requestToken, requestTokenSecret, results) {
            if (error) {
                ...
                console.log("+++ 54 routes.js request.session.twitterRequest.twitterRequestToken: ", request.session.twitterRequest.twitterRequestToken)
...
router.get('/twitterAuthenticated', function(request, response) {
    console.log("+++ 63 routes.js at /twitterAuthenticated")
    console.log("+++ 64 routes.js request: ", request.session)
